...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TaskView_t, stringdata) + ofs \
...
const QMetaObject TaskView::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_TaskView.data,
      qt_meta_data_TaskView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TaskView.stringdata))
